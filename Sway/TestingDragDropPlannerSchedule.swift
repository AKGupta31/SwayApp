...
//            data[collectionView.tag][indexPath.row].color = UIColor(named: "kThemeBlue")!
////            di.color = UIColor(named: "kThemeBlue")!
...
//            data[collectionView.tag][indexPath.row].color = .clear
...
//        
//        data[collectionView.tag][to.row].color = UIColor(named: "kThemeBlue")!
//        data[collectionView.tag][to.row].isSelected = true
//        data[collectionView.tag][from.row].color = .clear
//        data[collectionView.tag][from.row].isSelected = false
////        data[collectionView.tag][to.row].startDate = fromDataItem.startDate
//        
//        
////
